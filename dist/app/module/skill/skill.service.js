...
const createSkillIntoDB = (payLoad) => __awaiter(void 0, void 0, void 0, function* () {
    const skill = yield skill_model_1.default.create(payLoad);
    return skill;
});
...
const updateSkillIntoDB = (id, payLoad) => __awaiter(void 0, void 0, void 0, function* () {
    const skill = yield skill_model_1.default.findByIdAndUpdate(id, payLoad, { new: true });
    if (!skill) {
...
const deleteSkillFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const skill = yield skill_model_1.default.findByIdAndDelete(id);
    if (!skill) {
        throw new AppError_1.default(http_status_1.default.NOT_FOUND, "Skill not found");
    }
    return skill;
